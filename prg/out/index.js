...
__decorate([
    terminale_metodo_1.mpMet(terminale_metodo_1.TypeMetodo.get, '123445567'),
    __param(0, terminale_parametro_1.mpPar(tools_1.IType.text)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ClasseTest.prototype, "SetNome", null);
ClasseTest = __decorate([
    terminale_classe_1.mpClass('classe-test'),
    __metadata("design:paramtypes", [String])
], ClasseTest);
let ClasseTestSeconda = class ClasseTestSeconda {
    constructor(nome) {
        this.nome = nome;
    }
    SetNome(nomeFuturo) {
...
__decorate([
    terminale_metodo_1.mpMet(terminale_metodo_1.TypeMetodo.get, 'lllloko'),
    __param(0, terminale_parametro_1.mpPar(tools_1.IType.text)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ClasseTestSeconda.prototype, "SetNome", null);
ClasseTestSeconda = __decorate([
    terminale_classe_1.mpClass('classe-test-1'),
    __metadata("design:paramtypes", [String])
], ClasseTestSeconda);
/* @mpClass('classe1')
class Classe1 {
